...
import 'package:pagination_app/presentation/search/widets/product_widgets_card.dart';
...
class PostsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 248, 242, 254),
      appBar: AppBar(
        title: Text("Posts"),
      ),
      body: _postList(),
